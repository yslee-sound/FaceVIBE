...
1.2. PowerShell:
```
- keystore 생성 예시 (최초 1회)
& "C:\Program Files\Android\Android Studio\jbr\bin\keytool.exe" -genkeypair -v -keystore "G:/secure/FaceMBTI/facembti-key.jks" -storetype JKS -keyalg RSA -keysize 2048 -validity 36500 -alias facembti-alias
